...
export const AddressForm = ({ countries, address }: Props) => {
  ...
  const addressStored = useAddressStore(state => state.address);
    ...
    <form
      ...
      <div className="flex flex-col mb-2 sm:mt-1">
        <div className="inline-flex items-center mb-10">
          ...
          <span className="ml-4">¿Recordar dirección?</span>
        </div>
        <button
          type="submit"
        ...
        {error && (
          <div className="m-4 flex flex-row justify-center">
            ...
            <p className="text-sm text-red-500 mr-4">{error}</p>
          </div>
        )}
      </div>
    </form>
